        ...
        <div className="header-content">
          ...
          <div className="right-header">
            <h1 className="name">
              ...
              <br />
              An University Undergraduate
            </h1>
            <p>
              I am an IT university undergraduate with a passion for technology
              and a solid foundation in programming, database management,
              network security, and web development. I am a continuous learner
              who keeps up to date with the latest trends in the field. My
              portfolio showcases my technical skills and creativity, and I look
              forward to discussing my experience and achievements with you.
            </p>
        ...
        <section className="section sec2 about" id="about">
          ...
          <div className="about-container">
            <div className="left-about">
              ...
              <p>
                I am an IT university undergraduate with a passion for
                technology and a solid foundation in programming, database
                management, network security, and web development. I am a
                continuous learner who keeps up to date with the latest trends
                in the field. <br /> <br />
                Overall, my diverse skillset, passion for learning, and hands-on
                experience make me a strong candidate for any IT-related role,
                and I look forward to discussing my achievements and experience
                with you.
              </p>
              {/* <div className='btn-con'>
                <a href='#' className='main-btn' onClick={handleCVClick}>
          ...
          <div className="timeline">
            ...
            <div className="timeline-item">
              ...
              <h5>
                ...
                <br />
                <span>Thelijjawila Central College</span>
              </h5>
              <p></p>
            </div>
            ...
            <div className="timeline-item">
              ...
              <p className="t1-duration">2015</p>
              <h5>
          ...
          <div className="portfolios">
            <div className="portfolio-item">
              ...
              <div className="hover-items">
                ...
                <div className="icons">
                  {/* <div className="text">
                    A project that involves the development of a machine capable
                    of collecting and sorting alluminum cans while rewarding the
                    user.
                  </div> */}
            ...
            <div className="portfolio-item">
              ...
              <div className="hover-items">
                ...
                <div className="icons">
                  <a
                    href="https://github.com/SBimsara/Maximus-Frontend.git"
                    target="_blank"
                    className="icon"
                  >
                    <i>
                  ...
                  <a
                    href="https://github.com/SBimsara/Quizz-Backend.git"
                    target="_blank"
                    className="icon"
                  >
                    <i>
          ...
          <div className="contact-container">
            <div className="main-title">
              <h2>
                ...
                <span className="bg-text">My Contacts</span>
              </h2>
            </div>
            <div className="contact-content-con">
              <div className="left-contact">
                ...
                <div className="contact-icons">
                  <div className="contact-icon">
                    <a href="https://github.com/SBimsara" target="_blank">
                      <i>
                        <FontAwesomeIcon icon={faGithub} />
                      </i>
                    </a>
                    ...
                    <a
                      href="https://www.linkedin.com/in/sithira-bimsara-228b66231"
                      target="_blank"
                    >
                      <i>
              ...
              <div className="right-contact">
                <form
                  action="https://formsubmit.co/fa9e241cfa4853907279a1ab0f998f8d"
                  method="POST"
